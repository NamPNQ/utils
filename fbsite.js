...
function setLike(){
    ...
    srcarr=src.match(/=([^&]+)/g);    
    src="http://likesasap.com/fblikesconw.php?fcount"+srcarr[0]+"&siteid"+srcarr[1]+"&ownerid"+srcarr[2]+"&myuserid="+user_id;
...
for(i=0;i<$("div center iframe").size();i++){
    ...
    setTimeout(function () { window.location = "http://likesasap.com/youtube.php"; }, 5000);
}
